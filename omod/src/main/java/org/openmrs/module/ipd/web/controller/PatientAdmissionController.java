/**
 * <p> File: org.openmrs.module.ipd.web.controller.PatientAdmissionController.java </p>
 ...
 * <p> Version: $1.0 </p>
 * <p> Create date: Mar 18, 2011 12:43:04 PM </p>
 * <p> Update date: Mar 18, 2011 12:43:04 PM </p>
 **/
...
/**
 * <p> Class: PatientAdmissionController </p>
...
public class PatientAdmissionController {
	...
	public String firstView(
		...
		List<IpdPatientAdmission> listPatientAdmission = ipdService.searchIpdPatientAdmission(searchPatient, IpdUtils.convertStringToList(doctorString), fromDate, toDate,IpdUtils.convertStringToList(ipdWardString), "");
	...
	/*	String patientName = request.getParameter("patientName");
		...
		try {
			...
			EncounterType encounterType = Context.getService(HospitalCoreService.class).insertEncounterTypeByKey(HospitalCoreConstants.PROPERTY_IPDENCOUNTER);
			...
			relationNameattr = admission.getPatient().getAttribute("Father/Husband Name");
